...
__all__ = [
    'OLE_YSIZE_HIMETRIC', 'OLE_XPOS_HIMETRIC', 'OLE_YSIZE_PIXELS',
    'Default', 'FONTNAME', 'OLE_TRISTATE', 'OLE_XPOS_CONTAINER',
    'IFontEventsDisp', 'Color', 'Picture', 'IFontDisp', 'StdFont',
    'Gray', 'Unchecked', 'FONTITALIC', 'LoadPictureConstants',
    'StdPicture', 'VgaColor', 'OLE_XPOS_PIXELS', 'FONTSIZE',
    'OLE_YPOS_HIMETRIC', 'OLE_YPOS_PIXELS', 'Monochrome',
    'IPictureDisp', 'OLE_XSIZE_CONTAINER', 'FontEvents',
    'OLE_XSIZE_PIXELS', 'IPicture', 'OLE_YSIZE_CONTAINER',
    'OLE_YPOS_CONTAINER', 'OLE_OPTEXCLUSIVE', 'OLE_COLOR', 'IFont',
    'OLE_XSIZE_HIMETRIC', 'OLE_HANDLE', 'Checked',
    'OLE_ENABLEDEFAULTBOOL', 'FONTBOLD', 'Font', 'FONTUNDERSCORE',
    'FONTSTRIKETHROUGH', 'OLE_CANCELBOOL'
]

_check_version('1.1.14', 1646794454.000000)
