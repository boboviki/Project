...
__all__ = [
    'vbext_wt_LinkedWindowFrame', 'vbext_wt_CodeWindow',
    'vbext_wt_MainWindow', 'vbextFileTypeProject',
    'vbext_ct_StdModule', 'ProjectTemplate', '_VBProjectsEvents',
    'Events', 'vbext_wt_Immediate', 'vbextFileTypeForm',
    '_dispCommandBarControlEvents', 'vbext_wt_Locals', 'AddIn',
    'Component', '_dispReferencesEvents', '_Properties',
    'vbextFileTypeRes', 'vbext_pk_Get', 'CodePane', '_AddIns',
    'CommandBarEvents', 'vbext_wt_Watch', '_VBComponents_Old',
    'vbext_ct_ActiveXDesigner', '_ReferencesEvents',
    'vbext_vm_Design', 'Windows', 'vbext_ws_Minimize',
    'vbext_vm_Break', 'vbextFileTypeDesigners', 'CodeModule',
    '_VBProjects', 'vbext_wt_Find', 'vbext_pk_Proc', 'vbext_ProcKind',
    'vbext_cv_ProcedureView', 'vbext_VBAMode', 'VBComponent',
    '_VBProject', '_Windows_old', 'vbext_rk_TypeLib',
    'vbext_ProjectProtection', '_dispReferences_Events',
    '_VBComponents', 'vbext_ProjectType', 'vbext_pt_HostProject',
    'vbext_ct_ClassModule', 'vbext_wt_PropertyWindow',
    '_VBComponent_Old', 'vbext_pt_StandAlone', 'vbext_wt_Designer',
    '_Windows', '_VBProject_Old', 'vbext_pp_locked', 'CodePanes',
    'vbextFileTypeExe', 'Addins', 'vbextFileTypeDocObject',
    'vbext_ws_Normal', 'VBProjects', 'Window', '_CodePane',
    '_CodePanes', '_CodeModule', 'vbext_pp_none', 'Application',
    '_Component', 'vbextFileTypeUserControl', 'vbext_ct_MSForm',
    'Properties', 'vbext_wt_Toolbox', 'References',
    '_VBComponentsEvents', 'vbext_cv_FullModuleView', 'VBComponents',
    'vbext_ComponentType', 'vbext_WindowType', 'vbext_RefKind',
    'vbextFileTypeGroupProject', 'ReferencesEvents', 'Components',
    'SelectedComponents', 'LinkedWindows', 'vbext_wt_FindReplace',
    'vbext_WindowState', '_Components', 'vbext_ct_Document',
    'vbext_wt_ProjectWindow', 'Property', '_dispVBComponentsEvents',
    'vbext_CodePaneview', '_References', 'vbext_vm_Run',
    'vbextFileTypePropertyPage', 'vbextFileTypeFrx',
    'vbext_ws_Maximize', 'vbextFileTypeBinary', 'VBProject',
    '_VBComponent', 'vbext_rk_Project', 'vbext_pk_Set',
    'vbextFileTypeModule', 'Reference', 'vbext_wt_Browser',
    'vbext_pk_Let', '_ProjectTemplate', 'vbextFileTypes',
    '_CommandBarControlEvents', 'vbextFileTypeClass',
    '_LinkedWindows', 'VBE', 'vbext_wt_ToolWindow', '_VBProjects_Old',
    '_dispVBProjectsEvents'
]

_check_version('1.1.14', 1649653690.528722)
